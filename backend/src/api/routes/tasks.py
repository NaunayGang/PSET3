...
def create_task(
    ...
    """
    use_case = CreateTaskUseCase(task_repo, incident_repo, user_repo, event_publisher=event_bus)
    try:
...
def update_task(
    ...
    """
    use_case = UpdateTaskUseCase(task_repo, user_repo, event_publisher=event_bus)
    try:
